...
function LoginFormSmall() {
  ...
  return (
    <form onSubmit={loginFormHandler} className='flex flex-col'>
      <div className='pt-2 pb-4 mb-6 -ml-8 -mr-8 text-base font-bold text-center border-b border-gray-200'>
